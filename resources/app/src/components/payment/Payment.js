                ...
                <div className="box cal" id="paymentInput" style={left}>
                    <form>
                        ...
                        <div className="box">
                            ...
                            <div className="row">
                                <div className="col-sm-6"><b>Date In:</b> {this.props.booking.DateIn.toUTCString()}<br></br></div>
                                <div className="col-sm-6"><b>Date Out:</b> {this.props.booking.DateOut.toUTCString()}<br></br></div>
                            </div>
                        </div>
                        <br></br>
                        <div className="box">
